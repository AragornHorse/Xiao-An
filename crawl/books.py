...
for j in range(100):
    for i in tqdm(range(30)):
        # 定义URL
        url = 'https://hf-mirror.com/datasets/boyiwei/Books3/resolve/main/Books3-{:02d}.jsonl?download=true'.format(i)

        # 定义本地保存的文件路径
        local_filename = r'G:\txt_datasets\books\Books3-{:02d}.jsonl'.format(i)
